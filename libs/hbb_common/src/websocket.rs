...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("127.0.0.1:31265"), "ws://127.0.0.1:31268");
        assert_eq!(check_ws("127.0.0.1:31266"), "ws://127.0.0.1:31268");
        assert_eq!(check_ws("127.0.0.1:31267"), "ws://127.0.0.1:31269");
        assert_eq!(check_ws("rustdesk.com:31265"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:31266"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:31267"), "ws://rustdesk.com/ws/relay");
        ...
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:31265"),
            "ws://[0:0:0:0:0:0:0:1]:31268"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:31266"),
            "ws://[0:0:0:0:0:0:0:1]:31268"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:31267"),
            "ws://[0:0:0:0:0:0:0:1]:31269"
        );
        assert_eq!(check_ws("rustdesk.com:31265"), "wss://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:31266"), "wss://rustdesk.com/ws/id");
        assert_eq!(
            check_ws("rustdesk.com:31267"),
            "wss://rustdesk.com/ws/relay"
        );
        // set relay-server with default port
        Config::set_option("relay-server".to_string(), "127.0.0.1:31267".to_string());
        assert_eq!(check_ws("127.0.0.1:31265"), "ws://127.0.0.1:31268");
        assert_eq!(check_ws("127.0.0.1:31266"), "ws://127.0.0.1:31268");
        assert_eq!(check_ws("127.0.0.1:31267"), "ws://127.0.0.1:31269");
